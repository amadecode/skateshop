...
<body>
    ...
    <!-- END HEADER -->
            ...
            <aside id="left-sidebar-nav">
                ...
                <a href="#" data-activates="slide-out" class="sidebar-collapse btn-floating btn-medium waves-effect waves-light indigo darken-4"><i class="mdi-maps-local-grocery-store indigo darken-2"></i></a>
            </aside>
